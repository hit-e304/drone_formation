...
if(NOT " " STREQUAL " ")
  ...
  foreach(idir ${_include_dirs})
    ...
    elseif("${idir} " STREQUAL "include ")
      ...
      message(FATAL_ERROR "Project 'formation_algorithm_leader_follower' specifies '${idir}' as an include dir, which is not found.  It does neither exist as an absolute directory nor in '/home/lihai/drone_test_ws/drone_formation/src/formation_algorithm_leader_follower/${idir}'.  ${_report}")
    endif()
